...
/// app bar, see [SliverFrostedAppBar], which embeds an [FrostedAppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
/// {@tool dartpad}
/// This sample shows the creation of an [FrostedAppBar] widget with the [shadowColor] and
...
///
/// {@tool dartpad}
/// This sample shows an [FrostedAppBar] with two action buttons with their primary
...
///  * [SliverFrostedAppBar], which uses [FrostedAppBar] to provide a flexible app bar that
...
class FrostedAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  factory FrostedAppBar.withSubtitle({
    Key? key,
    Widget? leading,
  ...
  /// Used by [Scaffold] to compute its [FrostedAppBar]'s overall height. The returned value is
  /// the same `preferredSize.height` unless [FrostedAppBar.toolbarHeight] was null and
  ...
  /// the app bar's [FrostedAppBar.bottom] widget.
  ...
  /// changes the [FrostedAppBar]'s size. A [SliverFrostedAppBar] in a [CustomScrollView]
  ...
  /// used by [SliverFrostedAppBar] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
  /// {@endtemplate}
...
///
/// {@tool dartpad}
/// This sample shows a [SliverFrostedAppBar] and it's behavior when using the
...
/// See also:
///
///  * [CustomScrollView], which integrates the [SliverFrostedAppBar] into its
///    scrolling.
...
///    can expand and collapse.
///  * <https://material.io/design/components/app-bars-top.html>
class SliverFrostedAppBar extends StatefulWidget {
  ...
  ///
  /// Returns a [SliverFrostedAppBar] configured with appropriate defaults
  ...
  /// See also:
  ///
  ///   * [FrostedAppBar], for a small or center-aligned top app bar.
  ...
  factory SliverFrostedAppBar.medium({
    Key? key,
    Widget? leading,
    bool automaticallyImplyLeading = true,
    Widget? title,
  ...
  ///
  /// {@tool dartpad}
  /// This sample shows how to use [SliverFrostedAppBar.large] in a [CustomScrollView].
  ///
  ...
  ///   * https://m3.material.io/components/top-app-bar/overview, the Material 3
  ///     app bar specification.
  factory SliverFrostedAppBar.large({
    Key? key,
    Widget? leading,
    bool automaticallyImplyLeading = true,
    Widget? title,
  ...
  factory SliverFrostedAppBar.withSubtitle({
    Key? key,
    Widget? leading,
    bool automaticallyImplyLeading = true,
    Widget? title,
  ...
  /// See also:
  ///
  ///  * [SliverFrostedAppBar] for more animated examples of how this property changes the
  ...
  @override
  State<SliverFrostedAppBar> createState() => _SliverFrostedAppBarState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _SliverFrostedAppBarState extends State<SliverFrostedAppBar>
  ...
  @override
  void didUpdateWidget(SliverFrostedAppBar oldWidget) {
